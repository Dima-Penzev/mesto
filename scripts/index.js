...
//Функция создания карточки с картинкой и подписью
...
const addCardImage = () => {
  const newCardElement = createCard({name: inputCardTitle.value, link: inputCardLink.value});
...
btnAddCard.addEventListener('click', () => {openPopUp(popUpCardEditor)});
